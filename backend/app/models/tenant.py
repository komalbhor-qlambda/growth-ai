...
class Tenant(Base, UUIDMixin, TimestampMixin):
    ...
    subscription_status:   Mapped[SubscriptionStatus] = mapped_column(SAEnum(SubscriptionStatus), default=SubscriptionStatus.trialing)
...
class Lead(Base, UUIDMixin, TimestampMixin):
    ...
    status:       Mapped[LeadStatus]    = mapped_column(SAEnum(LeadStatus), default=LeadStatus.ai_handled)
...
class KBDocument(Base, UUIDMixin, TimestampMixin):
    ...
    status:          Mapped[KBDocStatus] = mapped_column(SAEnum(KBDocStatus), default=KBDocStatus.processing)
...
class Invoice(Base, UUIDMixin, TimestampMixin):
    ...
    billing_cycle:       Mapped[BillingCycle] = mapped_column(SAEnum(BillingCycle), default=BillingCycle.monthly)
